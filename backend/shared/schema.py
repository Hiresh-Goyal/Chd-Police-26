...
system_users_table = Table(
    ...
    Column("badge_number", Text, nullable=False),
...
audit_logs_table = Table(
    ...
    metadata,
    Column("id", Text, primary_key=True),                          # uuid4
    Column("timestamp", Text, nullable=False),                     # UTC ISO-8601
    Column("officer_name", Text, nullable=False),
    Column("officer_id", Text, nullable=False),
    Column("officer_role", Text, nullable=False),
    Column("officer_station", Text, nullable=False),
    Column("action", Text, nullable=False),
    Column("target_entity", Text, nullable=False),
    Column("domain", Text, nullable=False),
    Column("ip_address", Text, nullable=False),
    Column("device_id", Text, nullable=False),
    Column("status", Text, nullable=False),
    Column("raw_metadata", Text, nullable=False),                  # JSON string
)

sentinel_items_table = Table(
    "sentinel_items",
    metadata,
    Column("id", Text, primary_key=True),                          # uuid4
    Column("target_id", Text, nullable=False),                     # phone number, IMEI, etc.
    Column("type", Text, nullable=False),                          # PERSON, PHONE, BANK, etc.
    Column("domain", Text, nullable=False),                        # CDR, BANK, etc.
    Column("status", Text, nullable=False),                        # ACTIVE, PENDING, RESOLVED
    Column("severity", Text, nullable=False),                      # CRITICAL, HIGH, MEDIUM, LOW
    Column("last_active", Text, nullable=False),                   # UTC ISO-8601
...
# Aliases for resolution strategies
