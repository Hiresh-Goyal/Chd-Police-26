    ...
    <header className="h-16 bg-[#0B2340] text-white flex items-center justify-between px-5 fixed left-0 right-0 top-0 z-[9990] shadow-[0_1px_4px_rgba(11,35,64,0.14)] select-none">
      ...
      <div className="flex items-center gap-3">
        ...
        <div
          ...
          title="Profile"
        >
          {localStorage.getItem('ds_role') === 'admin' ? 'AD' : 'IO'}
        </div>
        ...
        <button
          ...
          className="w-8 h-8 ml-1 rounded flex items-center justify-center text-red-300 hover:text-white hover:bg-red-500/20 transition-colors"
          title="Logout"
          aria-label="Logout"
        >
